...
🛠️ Tools & Libraries Used Frontend: React JS
...
📦 How It Works Users can register, log in, update their profile, and interact with posts and stories.
...
About
A full-stack real-time social media app built with React, Node.js, Socket.IO, MongoDB.
